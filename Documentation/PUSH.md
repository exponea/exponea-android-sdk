...
In the Exponea SDK configuration, you can enable or disable the automatic push notification tracking setting the Boolean value to the `isAutoPushNotification` property and setting up the desired frequency to the `tokenUpdateFrequency`.
